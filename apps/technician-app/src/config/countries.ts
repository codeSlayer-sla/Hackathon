// Fixed list, not free text: a technician typing "panama" one day and
// "Pnama" (typo) or "Panama" (no accent) another day would fragment the
// same country into different strings across observations -- breaks
// anything that groups/filters by country downstream (analytics, NL
// queries). Every technician on the same list means every observation uses
// the exact same canonical spelling.
export const COUNTRIES: string[] = [
  ...
  'Estados Unidos', 'Estonia', 'Esuatini', 'Etiopía', 'Filipinas',
